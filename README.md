...
- [Setup & Installation Guide](#-setup--installation-guide)
  ...
  - [Frontend Setup](#1-frontend-setup-react)
  - [Backend Setup](#2-backend-setup-flask--sqlalchemy)
  - [Environment Variables & Secrets](#environment-variables--secrets)
  - [Database Initialization](#3-database-initialization)
  - [AWS EC2 Deployment](#4-deploying-to-aws-ec2)
...
- [Backend Documentation](#backend-documentation)
  - [Models](#modelspy)
  - [Schemas](#schemaspy)
  - [Key Utilities](#key_utilspy)
  - [Configuration](#configpy)
  - [Base Configuration](#basepy)
  - [Application Entry](#apppy)
  - [Credential Setup](#setup_credpy)
  - [Plaid Configuration](#plaid_client_configpy)
  - [Database Initialization](#init_keys_tablepy)
  - [Mock Data](#jared_mock_datapy)
  - [User Routes](#userpy)
  - [Transaction Routes](#transactionpy)
  - [Tax Info Routes](#tax_infopy)
  - [Savings Routes](#savingspy)
- [Security Documentation](#security-documentation)
  ...
  - [Bank Integration Security](#security-measures-for-bank-integration)
  - [Monitoring and Logging](#monitoring-and-logging)
  - [Incident Response](#incident-response)
  - [User Recommendations](#recommendations-for-users)
